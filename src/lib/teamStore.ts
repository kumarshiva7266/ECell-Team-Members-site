...
const INITIAL_MEMBERS: Member[] = [
  ...
  {
    id: "2",
    name: "SHIV PRASAD GAUD",
    role: "Web & Tech Head",
    domain: "Web & Technology",
    dept: "CSE (AI & ML)",
    year: "4th Year",
    skills: ["Python", "C", "C++", "Java", "JavaScript", "TypeScript", "HTML", "CSS", "React", "Node.js", "Full Stack Development", "MySQL", "MongoDB", "Firebase (Authentication, Firestore)", "MS Excel", "MS PowerPoint", "Git", "Razorpay API"],
    about: "Detail-oriented engineering fresher with hands-on experience in software development and project execution. Demonstrates strong analytical thinking, structured problem-solving, and the ability to collaborate effectively within diverse teams. Seeking an opportunity to contribute to organizational goals by delivering reliable solutions while continuously enhancing technical and professional skills in a corporate environment.",
    ...
    achievements: [
      "Recognized as Best Performer at ElevateLabs during AI & ML Internship",
      "Gained hands-on experience building full-stack web applications at Cognifyz Technologies",
      "Developed responsive and scalable web applications at CODTECH IT Solutions",
      "Developed a full-stack event ticket booking platform for E-Cell with Razorpay integration",
      "Built an AI-powered face recognition attendance system using OpenCV and Firebase"
    ],
    isCore: true,
    memberSince: "July 2024",
    status: "Core Executive Member",
    location: "Hyderabad, India - 500039",
    availability: "Available for Collaboration",
    responsibilities: [
      "Web & Tech Head — E-Cell, IIT Bombay: Leading web platforms, technical workflows, and digital infrastructure for large-scale entrepreneurial events.",
      "Designing Head — Computer Society of India (CSI): Driving UI/UX design, branding, and creative execution for technical events and initiatives.",
      "Technical Club Head — College Technical Club: Overseeing technical activities, mentoring members, and coordinating project-based learning and events."
    ],
    ...
    projectProgresses: [
      { name: "E-Cell Ticket Booking Website", progress: 100 },
      { name: "Face Recognition Attendance System", progress: 100 },
      { name: "Cognifyz Full Stack Intern Projects", progress: 100 },
      { name: "ElevateLabs AI & ML Projects", progress: 100 }
    ],
    stats: [
      { label: "Projects Completed", value: "2+", icon: "💻" },
      { label: "Internships Done", value: "3", icon: "💼" },
      { label: "Certifications", value: "4", icon: "🏆" },
      { label: "CGPA", value: "8.45", icon: "📊" },
      { label: "Years in E-Cell", value: "2", icon: "⭐" },
      { label: "Languages Spoken", value: "3", icon: "🗣️" }
    ],
    leadershipSkills: ["Web Development", "AI/ML Engineering", "UI/UX Design", "Team Leadership", "Technical Mentoring", "Project Execution", "Analytical Thinking", "Process Management"],
    certificates: [
      "Introduction to Generative AI — Google Cloud / Simplilearn, Sep 2025",
      "Getting Started with Artificial Intelligence — IBM SkillsBuild, Mar 2025",
      "Learn CCNA 200-301 Network Fundamentals — Simplilearn, Nov 2024",
      "Business Analysis & Process Management — Coursera, Nov 2024"
    ],
    education: { degree: "B.Tech", college: "Pallavi Engineering College, Hyderabad (Affiliated by JNTUH)", dept: "Computer Science & Engineering", cgpa: "8.45", gradYear: "2027" },
    interests: ["Artificial Intelligence", "Machine Learning", "Full Stack Development", "UI/UX Design", "Network Fundamentals", "Business Analysis", "Process Management"],
