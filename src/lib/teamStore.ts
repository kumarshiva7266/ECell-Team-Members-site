...
const INITIAL_MEMBERS: Member[] = [
  ...
  },
  {
    ...
    dept: "CSE(AI & ML)",
    year: "2nd Year",
    skills: ["Copywriting", "Growth Strategy", "Analytics", "Content Marketing", "Social Media Management", "Email Marketing", "SEO Optimization", "Data Analysis", "A/B Testing", "Conversion Optimization", "Brand Messaging", "Campaign Execution"],
    about: "Drafting copy, optimizing user conversions, and running analytics on campus promotions. Creating engaging content for social media, websites, and promotional materials. Conducting market research to identify growth opportunities and target audiences. Managing content calendars and ensuring consistent brand messaging across channels. Tracking campaign performance and providing data-driven insights for improvement.",
    email: "28thribhuvana@gmail.com",
    linkedin: "https://in.linkedin.com/in/bhuvana-undefined-0a9676300",
    github: "https://github.com",
    instagram: "https://instagram.com",
    portfolio: "",
    resumeUrl: "/resume/bhuvana.pdf",
    img: "/images/vp.png",
    achievements: ["Organized campus startup expo promotions"],
    isCore: true,
    memberSince: "May 2026",
    status: "Core Executive Member",
    location: "Hyderabad, Telangana",
    availability: "Available for Collaboration",
    responsibilities: [
      "Draft compelling copy for social media and marketing materials",
      "Optimize user conversions through content strategies",
      "Run analytics on campus promotions and campaign performance",
      "Create engaging content for websites and promotional materials",
      "Conduct market research to identify growth opportunities",
      "Manage content calendars and ensure consistent brand messaging",
      "Track campaign performance and provide data-driven insights",
      "Collaborate with design team for visual content alignment"
    ],
    roleImpact: "The Marketing Coordinator drives E-Cell's content engine — crafting compelling copy, optimizing conversions, analyzing campaign data, and ensuring consistent brand messaging across all channels.",
    projectProgresses: [
      { name: "Content Strategy 2026", progress: 75 },
      { name: "Conversion Optimization Campaign", progress: 60 },
      { name: "Market Research Initiative", progress: 50 },
      { name: "Brand Messaging Framework", progress: null }
    ],
    stats: [
      { label: "Content Pieces Created", value: "80+", icon: "✍️" },
      { label: "Campaigns Optimized", value: "12", icon: "📈" },
      { label: "Conversion Rate", value: "15%", icon: "🎯" },
      { label: "Social Engagement", value: "10K+", icon: "👥" },
      { label: "Years in E-Cell", value: "1", icon: "⭐" },
      { label: "Research Studies", value: "5", icon: "📊" }
    ],
    leadershipSkills: ["Copywriting", "Content Strategy", "Analytics", "Growth Marketing", "SEO Optimization", "A/B Testing", "Brand Messaging", "Data Analysis"],
    certificates: ["Google Analytics", "HubSpot Content Marketing", "SEO Certification", "Facebook Ads"],
    education: { degree: "B.Tech", college: "Pallavi Engineering College", dept: "CSE – AI & ML", cgpa: "8.7", gradYear: "2029" },
    interests: ["Content Marketing", "Digital Strategy", "Consumer Psychology", "Brand Storytelling", "Social Media Trends", "Data Analytics", "SEO", "Growth Hacking"],
    favoriteQuote: "Content is fire. Social media is gasoline.",
    personalWebsite: ""
  },
  {
    id: "10",
  ...
  /* ── Creative & Design ── */
  {
    ...
    education: { degree: "B.Des", college: "Pallavi Engineering College", dept: "Design & Visual Arts", cgpa: "8.5", gradYear: "2029" },
  ...
  },
  {
    ...
    dept: "CSE",
    year: "2nd Year",
    skills: ["Operations", "Communication", "Event Sprints", "Volunteer Management", "Venue Layout Design", "Schedule Coordination", "Team Leadership", "Crisis Management", "On-ground Execution", "Resource Planning", "Time Management", "Quality Assurance"],
    about: "Coordinating venue layouts, volunteer groups, and timing schedules during event bootcamps. Managing volunteer assignments and ensuring proper team coordination during events. Designing venue layouts and floor plans for optimal event flow and experience. Creating and managing event timelines to ensure all activities run on schedule. Supporting logistics team in troubleshooting and resolving on-ground issues.",
    email: "bhavani@ecell.ac.in",
    linkedin: "https://linkedin.com",
    github: "https://github.com",
    instagram: "https://instagram.com",
    portfolio: "",
    ...
    achievements: ["Optimized volunteer shift allocations"],
    isCore: true,
    memberSince: "May 2026",
    status: "Core Executive Member",
    location: "Hyderabad, Telangana",
    availability: "Available for Collaboration",
    responsibilities: [
      "Coordinate venue layouts and floor plans for events",
      "Manage volunteer assignments and team coordination",
      "Create and manage event timelines and schedules",
      "Support logistics team in on-ground execution",
      "Ensure proper team coordination during events",
      "Design venue layouts for optimal event flow",
      "Manage volunteer shift schedules and assignments",
      "Troubleshoot and resolve on-ground issues during events"
    ],
    roleImpact: "The Event Management Coordinator ensures seamless event operations — coordinating volunteers, managing schedules, designing layouts, and supporting on-ground execution for successful events.",
    projectProgresses: [
      { name: "Volunteer Management System", progress: 70 },
      { name: "Venue Layout Framework", progress: 65 },
      { name: "Event Scheduling Protocol", progress: 55 },
      { name: "On-ground Support System", progress: null }
    ],
    stats: [
      { label: "Volunteers Managed", value: "50+", icon: "👥" },
      { label: "Events Coordinated", value: "10", icon: "🎯" },
      { label: "Shifts Scheduled", value: "100+", icon: "📅" },
      { label: "Team Efficiency", value: "95%", icon: "⚡" },
      { label: "Years in E-Cell", value: "1", icon: "⭐" },
      { label: "Issues Resolved", value: "25", icon: "🔧" }
    ],
    leadershipSkills: ["Operations", "Communication", "Team Leadership", "Venue Design", "Schedule Coordination", "Crisis Management", "Resource Planning", "Quality Assurance"],
    certificates: ["Team Leadership", "Event Coordination", "Crisis Management", "Venue Operations"],
    education: { degree: "B.Tech", college: "Pallavi Engineering College", dept: "CSE", cgpa: "8.6", gradYear: "2029" },
  ...
  /* ── Social Media & Influencer ── */
  {
    ...
    instagram: "https://instagram.com",
    portfolio: "",
    resumeUrl: "/resume/balamurali.pdf",
